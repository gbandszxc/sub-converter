...
1. 项目目录下任何代码、文档修改前，先同步 Git 远端代码。涉及冲突优先语义合并。
...
### 5.1 必须与代码同步维护（漂移会误导用户或后续 agent）
...
## 6. 容易漂移的具体事实（改代码时顺手核对）

这些是「同一事实被写在多处」的高风险项：

1. **测试数量** —— 出现在 `README.md`、`README.zh-CN.md`、`AGENTS.md` 第 3 节。
